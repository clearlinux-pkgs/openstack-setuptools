...
Source0  : https://files.pythonhosted.org/packages/d9/d5/8c0f83909f6054a587018dc10f3feff0d9e3315b1b5d519c790996cbd724/setuptools-49.4.0.zip
...
%prep
%setup -q -n setuptools-49.4.0
cd %{_builddir}/setuptools-49.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597333540
...
cp %{_builddir}/setuptools-49.4.0/LICENSE %{buildroot}/usr/share/package-licenses/openstack-setuptools/a5234543d56e03c950c0080826b53a0cb97671af
